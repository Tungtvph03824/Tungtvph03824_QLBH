...
<asp:Content ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section id="passwordForm">
        ...
        <p>Bạn đã nhập vào như <strong><%: User.Identity.Name %></strong>.</p>

        <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
            <p>
               Bạn không có tài khoản cục bộ để đăng nhập, thêm mật khẩu cục bộ
            </p>
            <fieldset>
            ...
            <asp:ChangePassword runat="server" CancelDestinationPageUrl="~/" ViewStateMode="Disabled" RenderOuterTable="false" SuccessPageUrl="Manage.aspx?m=ChangePwdSuccess">
                <ChangePasswordTemplate>
                    ...
                    <fieldset class="changePassword">
                        ...
                        <ol>
                            <li>
                                <asp:Label runat="server" ID="CurrentPasswordLabel" AssociatedControlID="CurrentPassword">Mật khẩu gần đây</asp:Label>
                            ...
                            <li>
                                <asp:Label runat="server" ID="ConfirmNewPasswordLabel" AssociatedControlID="ConfirmNewPassword">Nhập lại mật khẩu mới</asp:Label>
    ...
    <section id="externalLoginsForm">
        ...
        <asp:ListView runat="server"
            ...
            <LayoutTemplate>
                ...
                <table>
                    <thead><tr><th>Service</th><th>Người dùng</th><th>Người dùng trước</th><th>&nbsp;</th></tr></thead>
                    <tbody>
